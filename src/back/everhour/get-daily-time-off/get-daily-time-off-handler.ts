import { getDailyDates, logger } from '@common/common-function';
import axios, { AxiosResponse } from 'axios';
import type { IGetTimeOffRequestBody, IGetTimeOffResponseBody } from '@back/everhour/get-timeoff/get-timeoff-interface';

export async function getDailyTimeOff(): Promise<IGetTimeOffResponseBody[] | []> {
  const { todayFormatted, laterFormatted } = getDailyDates();
  try {
